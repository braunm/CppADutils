...
dgamma_test <- function(X_, R_, A_) {
    .Call('CppADutils_dgamma_test', PACKAGE = 'CppADutils', X_, R_, A_)
}
...
LKJ_test <- function(Y_, eta_, K) {
    .Call('CppADutils_LKJ_test', PACKAGE = 'CppADutils', Y_, eta_, K)
}
...
cppad_dgamma_log <- function(X) {
    .Call('CppADutils_cppad_dgamma_log', PACKAGE = 'CppADutils', X)
}
